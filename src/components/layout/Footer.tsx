      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-1 text-xs text-white/50 sm:flex-row sm:justify-between">
        <p className="flex items-center gap-1.5">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 font-medium text-white/70 underline underline-offset-2 hover:text-white"
          >
            <svg className="h-3.5 w-3.5 fill-[#FF0000]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="flex items-center gap-1.5">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 font-medium text-white/70 underline underline-offset-2 hover:text-white"
          >
            <svg className="h-3.5 w-3.5 fill-[#0A66C2]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
