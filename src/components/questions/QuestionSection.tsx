...
const DIFFICULTY_LABELS = [
  { level: 1, label: "Basis", desc: "Herhaal wat je hebt geleerd", color: "from-green-400 to-emerald-500" },
  { level: 2, label: "Toepassen", desc: "Gebruik de stof in een bekende situatie", color: "from-blue-400 to-cyan-500" },
  { level: 3, label: "Uitdaging", desc: "Gebruik de stof in een nieuwe situatie", color: "from-orange-400 to-amber-500" },
  { level: 4, label: "Expert", desc: "Leg zelf verbanden en denk verder", color: "from-purple-400 to-violet-500" },
];
